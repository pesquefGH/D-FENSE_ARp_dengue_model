% Validation 2: forecast using a high-order AR(p) model
...
ind_v2=701;  % index of the end of EW 25 of 2023 (upper bound observed data for validation 2)

cc=kcc(1:ind_v2);  % observed cases from EW 1 of 2010 to EW 25 of 2023

cc(cc==0)=0.1;  % replaces null value in cc with a small value. This is because we will apply 
% a log2 function to the data values. 

lwea=2*52-25;   % number of EW to be forecast, i.e., from EW 26 of 2023 up to EW 52 2024
...
eek=mE(26:end);  % known mean excitation related to EW 26 of 2010 to EW 25 of 2023 
...
epiweek=[(202341:202352)';(202401:202440)'];
...
%writetable(T,['validation_2_ARp_',UF,'.csv'],'Delimiter',',')
...
writetable(T,['..\planilhas\validation_2_ARp_',UF,'.csv'],'Delimiter',',')
...
print(['..\plots\Validation2_ARp_',UF],'-dpdf')
