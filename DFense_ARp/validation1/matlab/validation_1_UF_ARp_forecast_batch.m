% Validation 1: forecast using a high-order AR(p) model
...
%clear all; close all; clc; % clears the workspace
...
kcc=M{:,2};  % known dengue cases from EW 1 of 2010 to EW 52 of 2023

ind_v1=649;  % index of the end of EW 25 of 2022 (upper bound observed data for validation 1)
...
lwea=2*52-25;   % number of EW to be forecast, i.e., from EW 26 of 2022 up to EW 52 2023
...
eek=mE(26:end);  % known mean excitation related to EW 26 of 2010 to EW 25 of 2022 
...
[q2p5_f]=round(ssa_modPE(forecast_cases_q2p5,L,nsv));  % filtered 2.5% quartile
[q5_f]=round(ssa_modPE(forecast_cases_q5,L,nsv));  % filtered 5% quartile
[q10_f]=round(ssa_modPE(forecast_cases_q10,L,nsv));  % filtered 10% quartile
[q25_f]=round(ssa_modPE(forecast_cases_q25,L,nsv));  % filtered 25% quartile
[q75_f]=round(ssa_modPE(forecast_cases_q75,L,nsv));  % filtered 75% quartile
[q90_f]=round(ssa_modPE(forecast_cases_q90,L,nsv));  % filtered 90% quartile
[q95_f]=round(ssa_modPE(forecast_cases_q95,L,nsv));  % filtered 95% quartile
[q97p5_f]=round(ssa_modPE(forecast_cases_q97p5,L,nsv));  % filtered 97.5% quartile
...
epiweek=[(202241:202252)';(202301:202340)'];
cases=kcc(indf_ini:indf_end);
...
q2p5=q2p5_f;  q2p5(1:gapf)=[]; q2p5=q2p5(1:pred_range); % 2.5% quartile 
q5=q5_f;  q5(1:gapf)=[]; q5=q5(1:pred_range); % 5% quartile 
q10=q10_f;  q10(1:gapf)=[]; q10=q10(1:pred_range); % 10% quartile 
q25=q25_f;  q25(1:gapf)=[]; q25=q25(1:pred_range); % 25% quartile 
q75=q75_f;  q75(1:gapf)=[]; q75=q75(1:pred_range); % 75% quartile
q90=q90_f;  q90(1:gapf)=[]; q90=q90(1:pred_range); % 90% quartile
q95=q95_f;  q95(1:gapf)=[]; q95=q95(1:pred_range); % 95% quartile
q97p5=q97p5_f;  q97p5(1:gapf)=[]; q97p5=q97p5(1:pred_range); % 97.5% quartile
...
writetable(T,['..\planilhas\validation_1_ARp_',UF,'.csv'],'Delimiter',',')
...
figure
subplot(221)
plot(EW_index,cases,'linewidth',2); % plot known sequence of cases up to EW 52 of 2023
hold on;
...
print(['..\plots\Validation1_ARp_',UF],'-dpdf')
